...
| — | `supabase_migration_exercises_athlete_update.sql` | RLS : athlète peut **ajouter / modifier / supprimer** les exercices de ses séances (carnet d’entraînement sur l’accueil) |
